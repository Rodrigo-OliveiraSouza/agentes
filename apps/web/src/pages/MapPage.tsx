...
export const MapPage = () => {
  ...
  const handleExportGeoJson = () => {
    if (!geojsonPayload) {
      notifyShare('Nao ha malha carregada para exportar.');
      return;
    }
  ...
  const handleExportReport = () => {
    ...
    const indicatorLabel = indicatorLabelFrom(indicator, indicators);
    const reportLines = [
      'RELATORIO TERRITORIAL - PROJETO LUIZA BARROS',
      ...
      '',
      'Resumo estatistico:',
      `- Minimo: ${mapStats ? mapStats.min.toLocaleString('pt-BR', { maximumFractionDigits: 2 }) : 'N/D'}`,
      `- Media: ${mapStats ? mapStats.average.toLocaleString('pt-BR', { maximumFractionDigits: 2 }) : 'N/D'}`,
      `- Maximo: ${mapStats ? mapStats.max.toLocaleString('pt-BR', { maximumFractionDigits: 2 }) : 'N/D'}`,
      '',
      'Top 15 territorios:',
    ...
    <div className="app-shell">
      <section id="mapa" className="map-shell" ref={mapShellRef}>
        <div className="map-page-nav">
          <a href="/">Projeto Luiza Barros - pagina de divulgacao</a>
          <span>Painel tecnico de mapas e indicadores</span>
        </div>
        <div className="map-shell-inner">
          <div className="map-governance">
            ...
            <div className="map-actions-row">
              ...
              <button type="button" onClick={handleExportReport}>Baixar relatorio</button>
