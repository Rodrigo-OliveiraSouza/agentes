...
export const INDICATORS: IndicatorDefinition[] = [
  {
    slug: 'population',
    label: 'População residente (IBGE)',
    unit: 'pessoas',
  ...
  {
    slug: 'gdp',
    label: 'PIB a preços correntes (IBGE)',
    unit: 'mil reais',
    source: 'IBGE PIB dos Municípios (agregado 5938, variável 37)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2002,
  ...
  },
  {
    ...
    label: 'Densidade demográfica (IBGE)',
    unit: 'hab/km2',
    source: 'IBGE Censo Demográfico (agregado 1301, variável 616)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2010,
  ...
  {
    slug: 'literacy_rate',
    label: 'Taxa de alfabetização (IBGE)',
    unit: '%',
    source: 'IBGE Censo Demográfico (agregado 1699, variável 1646, classificação 2[6794])',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2010,
  ...
  {
    slug: 'territory_area',
    label: 'Área territorial (IBGE/BrasilAPI)',
    unit: 'km2',
    source: 'IBGE Censo Demográfico (agregado 1301, variável 615)',
  ...
  },
  {
    ...
    unit: 'índice',
    source: 'Composto proxy com taxa de alfabetização, renda per capita e expectativa de vida (IBGE), inspirado na estrutura do IDH',
    ...
    yearMax: 2022,
    defaultYear: 2022,
    notes: 'Valor aproximado para leitura territorial rápida. IDH oficial segue no Atlas Brasil/PNUD.',
  },
  {
    slug: 'crime_rate',
    label: 'Taxa de criminalidade (proxy roubos)',
    unit: 'ocorrencias/100 mil',
    source: 'IBGE PNAD (agregado 8502, vítimas de roubo) normalizado por população; conector SINESP permanece plugável',
    sourceLabel: 'IBGE API + SINESP (plugável)',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2021,
    yearMax: 2021,
  ...
  },
  {
    ...
    unit: 'reais',
    source: 'Derivada de PIB municipal (agregado 5938) e população residente (agregado 10211)',
    ...
    yearMax: 2023,
    defaultYear: 2023,
    notes: 'Cálculo: (PIB em mil reais * 1000) / população.',
  },
  {
    slug: 'unemployment_rate',
    label: 'Taxa de desocupação (IBGE)',
    unit: '%',
  ...
  {
    slug: 'gini_index',
    label: 'Índice de Gini (IBGE)',
    unit: 'índice',
    source: 'IBGE Censo Demográfico (agregado 10301, variável 13418)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2022,
    yearMax: 2022,
    defaultYear: 2022,
    notes: 'Disponibilidade territorial na API: Brasil, região e UF.',
  },
  {
  ...
  },
  {
    ...
    label: 'Taxa de frequência escolar (IBGE)',
    unit: '%',
  ...
  },
  {
    ...
    label: 'Cobertura de pré-natal (IBGE)',
    unit: '%',
    ...
    yearMax: 2013,
    defaultYear: 2013,
    notes: 'Disponibilidade territorial na API: Brasil e região.',
  },
  {
    slug: 'primary_care_coverage',
    label: 'Cobertura de atenção primária (IBGE)',
    unit: '%',
    source: 'IBGE PNS (agregado 7631, variável 10954, cadastrados em unidade de saúde da família)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2019,
  ...
  },
  {
    ...
    label: 'Cobertura de água encanada (IBGE)',
    unit: '%',
  ...
  },
  {
    ...
    label: 'Domicílios com acesso à internet (IBGE)',
    unit: '%',
    source: 'IBGE Censo Demográfico (agregado 10201, variável 1013436, conexão domiciliar = sim)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2022,
  ...
  },
  {
    ...
    label: 'Domicílios com energia elétrica (IBGE)',
    unit: '%',
    source: 'IBGE Censo Demográfico (agregado 3157, variável 1000096, classificação 309[3011])',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2010,
  ...
  {
    slug: 'homicide_rate',
    label: 'Homicídios (IBGE ODS)',
    unit: 'óbitos/100 mil',
    source: 'IBGE ODS (agregado 6606, variável 13532)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2000,
  ...
  {
    slug: 'robbery_rate',
    label: 'Roubos (proxy domicílios vitimizados)',
    unit: 'ocorrencias/100 mil',
    source: 'IBGE PNAD (agregado 8512, domicílios com vítima de roubo) normalizado por população',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2021,
  ...
  },
  {
    ...
    label: 'Mortalidade no trânsito (IBGE ODS)',
    unit: 'óbitos/100 mil',
    source: 'IBGE ODS (agregado 4408, variável 9734)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2000,
  ...
  {
    slug: 'aging_index',
    label: 'Índice de envelhecimento (IBGE)',
    unit: 'índice',
    source: 'IBGE Censo Demográfico (agregado 9515, variável 10612)',
    sourceLabel: 'IBGE API',
    sourceUrl: SOURCE_URLS.ibge,
    supported: true,
    yearMin: 2022,
  ...
  switch (indicator) {
    ...
    default:
      throw new ApiError(
        ...
        'Indicador ainda não implementado no MVP. Fonte alternativa segue plugável.',
        { indicator },
      );
  }
};
...
export const fetchCityProfile = async (cityCode: string): Promise<CityProfilePayload> => {
  ...
  const cityName = population?.name ?? gdp?.name ?? density?.name ?? `Município ${cityCode}`;
  const gdpPerCapita =
  ...
  const metrics: CityProfileMetric[] = [
    ...
    buildMetric({
      ...
      label: 'Homicídios (taxa por 100 mil, UF)',
      category: 'seguranca',
      ...
      notes: 'Disponível por UF na API; em nível municipal a aplicação usa expansão por UF.',
    }),
    buildMetric({
      key: 'traffic_mortality_uf_proxy',
      label: 'Mortalidade no trânsito (taxa por 100 mil, UF)',
      category: 'saude',
    ...
    buildMetric({
      ...
      category: 'seguranca',
      source: 'IBGE API (PNAD vitimização por roubo, normalizado por população)',
      unit: 'ocorrencias/100 mil',
      year: 2021,
      value: crimeRate?.value ?? null,
      status: crimeRate ? 'ok' : 'unavailable',
      notes: 'SINESP/SENASP permanece conector plugável complementar.',
    }),
  ];
